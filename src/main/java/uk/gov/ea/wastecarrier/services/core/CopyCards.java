...
public class CopyCards
{
	...
	public enum RegistrationTier {
		LOWER(CopyCards.REGID_PREFIX_LOWER),
        UPPER(CopyCards.REGID_PREFIX_UPPER);
	...
	private Logger log = Logger.getLogger(CopyCards.class.getName());
    ...
    public boolean equals(Object obj) {
        ...
        final CopyCards other = (CopyCards) obj;
