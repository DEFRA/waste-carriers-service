...
if [[ -z "${WCRS_SERVICES_IR_RENEWAL_FOLDERPATH}" ]]; then env_alert WCRS_SERVICES_IR_RENEWAL_FOLDERPATH; fi
...
if [[ -z "${WCRS_SERVICES_EPR_EXPORT_FILE}" ]]; then env_alert WCRS_SERVICES_EPR_EXPORT_FILE; fi
...
sed -i "s/WCRS_REGISTRATION_RENEWAL_WINDOW/${WCRS_REGISTRATION_RENEWAL_WINDOW}/g" \
       "${WCRS_SERVICES_HOME}/${RELEASE_DIR}/conf/configuration.yml"
sed -i "s|WCRS_SERVICES_IR_RENEWAL_FOLDERPATH|${WCRS_SERVICES_IR_RENEWAL_FOLDERPATH}|g" \
       "${WCRS_SERVICES_HOME}/${RELEASE_DIR}/conf/configuration.yml"
sed -i "s|WCRS_SERVICES_EPR_EXPORT_FILE|${WCRS_SERVICES_EPR_EXPORT_FILE}|g" \
       "${WCRS_SERVICES_HOME}/${RELEASE_DIR}/conf/configuration.yml"
sed -i "s|WCRS_SERVICES_REPORTING_EXPORT_PATH|${WCRS_SERVICES_REPORTING_EXPORT_PATH}|g" \
       "${WCRS_SERVICES_HOME}/${RELEASE_DIR}/conf/configuration.yml"
